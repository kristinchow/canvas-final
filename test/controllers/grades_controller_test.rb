...
class GradesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grade" do
    assert_difference('Grade.count') do
      post grades_url, params: { grade: { assignment_id: @grade.assignment_id, score: @grade.score } }
    end
  ...
  test "should update grade" do
    patch grade_url(@grade), params: { grade: { assignment_id: @grade.assignment_id, score: @grade.score } }
